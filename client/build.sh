...
${nuget_cmd} install src/Cloudmersive.APIClient.NET.DocumentAI/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Cloudmersive.APIClient.NET.DocumentAI.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Cloudmersive.APIClient.NET.DocumentAI.dll \
-recurse:'src/Cloudmersive.APIClient.NET.DocumentAI/*.cs' \
-doc:bin/Cloudmersive.APIClient.NET.DocumentAI.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Cloudmersive.APIClient.NET.DocumentAI.dll was created successfully"
fi
